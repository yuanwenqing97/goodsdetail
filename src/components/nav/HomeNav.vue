      ...
      <div class="nav-side" ref="navSide">
        <ul>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">商品分类</span>
          </li>
          ...
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            ...
            <span class="nav-side-item">运动户外</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">女鞋</span> /
            <span class="nav-side-item">男生</span> /
            <span class="nav-side-item">箱包</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">美妆</span> /
            <span class="nav-side-item">个人护理</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">腕表</span> /
            <span class="nav-side-item">眼镜</span> /
            <span class="nav-side-item">珠宝饰品</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">手机</span> /
            <span class="nav-side-item">数码</span> /
            <span class="nav-side-item">电脑办公</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">男鞋</span> /
          ...
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">母婴玩具</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">零食</span> /
            <span class="nav-side-item">茶酒</span> /
            <span class="nav-side-item">进口食品</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">生鲜水果</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">大家电</span> /
            <span class="nav-side-item">生活电器</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">家具建材</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">汽车</span> /
            <span class="nav-side-item">配件</span> /
            <span class="nav-side-item">用品</span>
          </li>
        </ul>
      </div>
