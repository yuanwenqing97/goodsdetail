...
const ShopBroadcast = resolve => require(['@/components/broadcast/ShopBroadcast'], resolve);
const ShopList = resolve => require(['@/components/shop/ShopList'], resolve);
const ShopItems = resolve => require(['@/components/shop/ShopItems'], resolve);
